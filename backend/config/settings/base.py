...
SECRET_KEY = os.environ.get('SECRET_KEY', 'dev_secret_key_mini_dmart_2026_super_secure')
...
RATELIMIT_VIEW = 'apps.accounts.views.login_view'
RATELIMIT_KEY_PREFIX = 'login'
...
# drf-spectacular documentation OpenAPI settings
SPECTACULAR_SETTINGS = {
    'TITLE': 'Mini D-Mart API',
    'DESCRIPTION': 'Enterprise Grocery E-Commerce Platform API Documentation',
    'VERSION': '1.0.0',
